    ...
    return (
        <div className="account_header">
            <div className="logo">
                <Link to="/account">
                    <img
                        src="../../../assets/images/png/logoMetamask.png"
                        alt="logo"
                    />
                </Link>
            </div>
            <div className="controls">
                <div className="networks">
                    <div className="networks_circle"></div>
                    <div className="networks_name">Ethereum Mainnet</div>&gt;
                </div>
                <div
                ...
                {isAccountShow && (
                    <div className="account_menu">
                        <div className="account_menu--title">My accounts</div>
                        ...
                        <div
                            className="account_menu--item border"
                            onClick={() => setIsAccountShow(false)}
                        >
                            Support
                        </div>
