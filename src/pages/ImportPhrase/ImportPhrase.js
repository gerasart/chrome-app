    ...
    return (
        <div className={phrase.Phrase}>
            ...
            <div className={main.text}>
                Only the first account in this wallet is automatically loaded.
                To add additional accounts, after completing this process, click
                on the drop-down menu and then select "Create Account".
            </div>
            <div className={phrase.secret}>
                <div className={phrase.text}>Recovery passphrase</div>
