...
export default function Privacy() {
    return (
        <div className={privacy.main}>
            <div className={main.h1}>Help us improve Chrome app</div>
            <div className={main.text}>
                Chrome app would like to collect basic usage data to better
                understand how our users interact with the extension. This data
                will be used to continually improve the usability and experience
                of using our product and the Ethereum ecosystem.
                <br />
                <br />
                Chrome app... <br />
                ...
                <br />
                Never stores keys, addresses, transactions, balances, hashes or
                any personal data <br />
